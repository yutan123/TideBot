...
四、隐私与数据
本应用尽力将数据保留在您的设备。但当您配置外部模型、外部访问服务或联网工具时，相关内容可能被发送至您选择的服务端。

五、外部服务
外部服务仅在您主动配置和授权后使用。请只使用来源可靠的服务，并审查其权限、网络地址和隐私政策。

六、未成年人
本应用仅面向年满 18 周岁的成年人。未满 18 周岁者不得自行使用本应用；监护人如允许使用，应全程承担监护责任并确保符合适用法律。

七、免责声明与责任限制
在法律允许范围内，TideBot 按现状提供，不保证服务不中断、无错误、适配所有设备或满足任何特定目的。对因网络、设备、系统、模型、第三方服务、用户配置或不当使用造成的损失，运营者在法律允许范围内不承担责任。法律另有强制规定的除外。
